...
use App\Livewire\Pages\NotificationPreferences\NotificationPreferences;
...
Route::prefix('admin')->middleware(['auth', 'verified', EnsureUserIsAdmin::class])->group(function () {
    ...
    Route::get('notifications-preferences', NotificationPreferences::class)->name('notification-preferences');
});
